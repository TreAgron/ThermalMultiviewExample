#!/usr/bin/env python3
# https://github.com/ITVRoC/FlirImageExtractor/blob/master/flir_image_extractor.py
# -*- coding: utf-8 -*-
...
# Based on: https://github.com/nationaldronesau/FlirImageExtractor/blob/master/flir_image_extractor_cli/flir_image_extractor.py
class FlirImageExtractor:
    ...
    def extract_thermal_image(self):
        ...
        return thermal_np, thermal_raw, meta
